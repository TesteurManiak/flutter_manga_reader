...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String sourceId,  bool favorite,  int fetchInterval,  DateTime? dateAdded,  String url,  String title,  String? artist,  String? author,  String? description,  List<String>? genres,  MangaStatus status,  String? thumbnailUrl,  UpdateStrategy updateStrategy,  bool initialized,  DateTime? lastModifiedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Manga() when $default != null:
return $default(_that.id,_that.sourceId,_that.favorite,_that.fetchInterval,_that.dateAdded,_that.url,_that.title,_that.artist,_that.author,_that.description,_that.genres,_that.status,_that.thumbnailUrl,_that.updateStrategy,_that.initialized,_that.lastModifiedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String sourceId,  bool favorite,  int fetchInterval,  DateTime? dateAdded,  String url,  String title,  String? artist,  String? author,  String? description,  List<String>? genres,  MangaStatus status,  String? thumbnailUrl,  UpdateStrategy updateStrategy,  bool initialized,  DateTime? lastModifiedAt)  $default,) {final _that = this;
switch (_that) {
case _Manga():
return $default(_that.id,_that.sourceId,_that.favorite,_that.fetchInterval,_that.dateAdded,_that.url,_that.title,_that.artist,_that.author,_that.description,_that.genres,_that.status,_that.thumbnailUrl,_that.updateStrategy,_that.initialized,_that.lastModifiedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String sourceId,  bool favorite,  int fetchInterval,  DateTime? dateAdded,  String url,  String title,  String? artist,  String? author,  String? description,  List<String>? genres,  MangaStatus status,  String? thumbnailUrl,  UpdateStrategy updateStrategy,  bool initialized,  DateTime? lastModifiedAt)?  $default,) {final _that = this;
switch (_that) {
case _Manga() when $default != null:
return $default(_that.id,_that.sourceId,_that.favorite,_that.fetchInterval,_that.dateAdded,_that.url,_that.title,_that.artist,_that.author,_that.description,_that.genres,_that.status,_that.thumbnailUrl,_that.updateStrategy,_that.initialized,_that.lastModifiedAt);case _:
  return null;
